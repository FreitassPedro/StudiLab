        ...
        <div className="px-6 pb-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-9 bg-foreground/5 border-border text-foreground placeholder:text-foreground/30 focus-visible:ring-1"
        ...
        <div className="max-h-[300px] overflow-y-auto px-2 pb-2">
          {filteredUsers.length === 0 ? (
            ...
            filteredUsers.map((user) => (
              <div 
                key={user.id} 
                className="flex items-center justify-between p-3 mx-2 my-1 rounded-xl hover:bg-foreground/5 transition-colors"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-foreground/40">@{user.username}</span>
                  </div>
                </div>
                <Button 
                  size="sm" 
                  variant="outline" 
                  className="bg-foreground/5 border-border hover:bg-foreground/10 text-xs h-8"
